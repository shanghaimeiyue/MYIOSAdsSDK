...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zhulonghaigit/MYIOSAdsSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zhulonghaigit' => 'karl@edimob.com' }
  s.source           = { :git => 'https://github.com/zhulonghaigit/MYIOSAdsSDK.git', :tag => s.version.to_s }
