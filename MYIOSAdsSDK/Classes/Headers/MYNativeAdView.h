...
@protocol MYNativeAdViewDelegate <NSObject>

/**
 * 原生广告曝光
 */
- (void)MY_nativeAdViewExpose;


/**
 * 原生广告点击
 */
- (void)MY_nativeAdViewDidClick;

@end

@interface MYNativeAdView : UIView

@property (nonatomic, weak) id<MYNativeAdViewDelegate> delegate;
 ...
 */
- (void)registerDataObject:(MYNativeAdDataObject *)dataObject
